...
### H17: make the proportion of training epochs changeable. 
...
if __name__ == "__main__": 
    ...
    for run_time in range(RUN_TIMES):
        ...
        if args.dataprepare: 
            ...
            run_once(model_save_dir, model_type=args.model, pretype=args.pretype, posttype="f", sel=args.select, preepochs=args.preepochs, postepochs=args.postepochs)
