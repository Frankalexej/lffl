...
def run_once(hyper_dir, pretype="f", posttype="f"): 
    ...
    special_recs = DictRecorder(os.path.join(model_save_dir, save_specialrecs_name))
    ...
    special_recs.append(("midval_loss", valid_loss / valid_num))
    special_recs.append(("midval_acc", valid_correct / valid_total))
    special_recs.save()
...
if __name__ == "__main__": 
    ...
    for run_time in range(RUN_TIMES):
        ...
        save_specialrecs_name = "special.hst"
