...
def run_once(hyper_dir, model_type="large", pretype="f", posttype="f", sel="full", preepochs=20, postepochs=20, on_site_eval=False, save_eval=True, eval_train=False, save_model=False): 
    ...
    eval_saver.save_eval_func(z_all, y_all, "valid", 0, save_eval)
    ...
    z_all, y_all = concat_func(z_list, y_list)
    eval_saver.save_eval_func(z_all, y_all, "full_valid", 0, save_eval)
...
if __name__ == "__main__": 
    ...
    for run_time in range(RUN_TIMES):
        ...
        if args.dataprepare: 
            ...
            for preepoch in [0, 2, 3, 4, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60]: # 10, 15, 20, 25, 30, 0, , 2, 3, 4, 5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60
