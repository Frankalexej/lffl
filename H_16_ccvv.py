...
### This time, we restore to C train C test, V train V test
...
def run_once(hyper_dir, model_type="large", pretype="f", posttype="f", sel="full"): 
    ...
    # Load Data (I&II)
    train_loader_1 = load_data(type=pretype, sel=sel, load="train")
    valid_loader_1 = load_data(type=pretype, sel=sel, load="valid")
    train_loader_2 = load_data(type=posttype, sel=sel, load="train")
