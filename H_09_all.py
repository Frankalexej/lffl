...
def run_once(hyper_dir, model_type="large", pretype="f", posttype="f", sel="full"): 
    ...
    # Load Data (I&II)
    _, valid_loader_1 = load_data(type=pretype, sel=sel)
    train_loader_1, _ = load_data(type=pretype, sel="full")
    _, valid_loader_2 = load_data(type=posttype, sel=sel)
    train_loader_2, _ = load_data(type=posttype, sel="full")
